<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="medicalLogin.aspx.cs" Inherits="pharmacolony.WebForm1" %>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <asp:Button ID="Button1" class="btn btn-primary btn-lg"
                                Style="padding-left: 2.5rem; padding-right: 2.5rem;" runat="server" OnClick="Button1_mediLogin" Text="Login" />
