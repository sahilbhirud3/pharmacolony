<%@ Page Title="" Language="C#" MasterPageFile="~/distMaster.Master" AutoEventWireup="true" CodeBehind="distOrderView.aspx.cs" Inherits="pharmacolony.distOrderView" %>
            ...
            <div class="row bg-title">
                <div class="col-lg-12">
                   ...
                   <div class="col-md-2"> <h5><asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Order ID" ></asp:Label></h5></div>
                    ...
                    <div class="col-md-2"> <h5><asp:Label ID="Label2" runat="server" Font-Bold="true" Text="Medical Name" ></asp:Label></h5></div>    
                    ...
                    <div class="col-md-2"><h6><asp:Label ID="order_details2" runat="server" ></asp:Label></h6></div>
                    </div>
                    <br />
                   <%-- <div class="row register-form">
                    ...
                    <asp:LinkButton ID="lnkEdit" CommandArgument='<%#Eval("id")%>' runat="server" 
                        CommandName="Edit" CssClass="btn-success" OnClick="lnkEdit_Click">Approve</asp:LinkButton>
                  ...
                  <div class="row"> 
                    ...
                    <asp:Button id="btnBack" class="btnBack" Text="Back" PostBackUrl="~/distOrder.aspx" runat="server"/>
                </div>
                </div>
