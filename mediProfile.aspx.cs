...
{
    public partial class mediProfile : System.Web.UI.Page
    {
        ...
        {
            medicalName.Text = (string)Session["medicalName"];
            medicalUser.Text = (string)Session["email"];
            licNo.Text=(string)Session["licno"];
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                string sql1 = "SELECT * FROM medical where licNo='"+Session["licno"]+"' ";
