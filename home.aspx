                            ...
                            <div class="col-md-12">
                                <div class="navbar-header">
                                    ...
                                    <div class="navbar-brand" style="height: 50px; padding: unset">
                                        <%--<img src="img/newlogo.gif" class="img-responsive" />--%>
                                    </div>
                                    <img src="img/newlogo1.gif" />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            ...
                            <hr class="botm-line" />
                            <p>Get rid from long queues and waiting<br />
                                Place your orders at one click for multiple distributors<br />
                                Get wider range of company's distributor for drugs/medicines.</br> Use our website and save your precious time</p>
                            <br />
                            </br><img src="img/stat.png" width="320px" />
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="service-info">
                                ...
                                <div class="icon-info">
                                    ...
                                    <p>Place order at anytime & from anywhere.</p>
                                    <br />
                                    <br />
                                </div>
                            </div>
                            <div class="service-info">
                                ...
                                <div class="icon-info">
                                    <h2>
                                        <asp:Label ID="Label2" runat="server" Text="Label">238</asp:Label></h2>
                                    <br />
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="service-info">
                                ...
                                <div class="icon-info">
                                    ...
                                    <p>Search more options for one medicine,see  more details about medicine. </p>
                                    <br />
                                </div>
                            </div>
                            <div class="service-info">
                                ...
                                <div class="icon-info">
                                    ...
                                    <h2>
                                        <asp:Label ID="Label1" runat="server" Text="Label">238</asp:Label></h2>
                                    <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="testi-details text-center">
                                <!-- Paragraph -->
                                <h3><a href="medicalLogin.aspx" class="">Login &nbsp   <span class="fa-solid fa-arrow-right"></span></a></h3>
                                <br />
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="testi-details text-center">
                                <!-- Paragraph -->
                                <h3><a href="distributorLogin.aspx" class="">Login &nbsp <span class="fa-solid fa-arrow-right"></span></a></h3>
                                <br />
                            </div>
                            <div class="testi-info">
                                <!-- User Image -->
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="testi-details text-center">
                                <!-- Paragraph -->
                                <h3><a href="adminLogin.aspx" class="">Login &nbsp  <span class="fa-solid fa-arrow-right"></span></a></h3>
                                <br />
                            </div>
                            <div class="testi-info">
                                <!-- User Image -->
                ...
                <div class="container">
                    <div class=" row">
                        ...
                        <div class="text-right-md col-md-4 col-sm-4">
                            <h2 class="section-title white lg-line">« A few words<br>
                                about us »</h2>
                        </div>
                        <div class="col-md-4 col-sm-5">
                            <p style="color: white">
                                Easy order processing between medical store and distributor.
...
Distributor will process orders received from medical stores through this system.
                            </p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <h3>Contact Info</h3>
                            <div class="space"></div>
                            <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>KTHM College<br>
                                Gangapur Road, Nashik 422002</p>
                            <div class="space"></div>
                            <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>chaitanyabhavar2021@gmail.com<br />
                                sahilbhirud3@gmail.com</p>
                            <div class="space"></div>
                            <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+91 9579213171
                                <br />
                                +91 8600386608</p>
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 col-sm-4 marb20">
                                ...
                                <div class="info-sec">
                                    <p>
                                        This website built to handle medical stores orders and also distributors order processing<br />
                                        in effective manner.<br />
                                        <br />
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 marb20">
                                ...
                                <div class="info-sec">
                                    <ul class="quick-info">
                                        <li><a href="#banner"><i class="fa-solid fa-house fa-fa-4x" style="font-size: medium"></i>&nbsp Home</a></li>
                                        <br />
                                        <li><a href="#explore"><i class="fa-brands fa-wpexplorer" style="font-size: medium"></i>&nbsp Explore</a></li>
                                        <br />
                            ...
                            <div class="col-md-4 col-sm-4 marb20">
                                <div class="ftr-tle">
                                    ...
                                    <h4 class="white no-padding">Build by :<br />
                                        <span style="margin-left: 80px">Bhavar Chaitanya Sitaram</h4>
                                    <div class="info-sec">
                                        <ul class="social-icon" style="margin-left: 80px">
                                            <a href="https://instagram.com/chaitanya_s_bhavar96k?igshid=YmMyMTA2M2Y=">
                                                <li>
                                                    <img src="img/instagram.png" /></li>
                                            </a>
                                            <a href="https://www.linkedin.com/in/chaitanyabhavar246">
                                                <li>
                                    ...
                                    <br />
                                    <br />
                                    <h4 class="white no-padding" style="margin-left: 80px">Bhirud Sahil Chudaman</h4>

                                    <div class="info-sec">
                                        <ul class="social-icon" style="margin-left: 80px">

                                            <a href="https://instagram.com/sahil.bhirud__sb?igshid=YmMyMTA2M2Y=">
                                                <li>
                                                    <img src="img/instagram.png" /></li>
                                            </a>
                                            <a href="https://www.linkedin.com/in/sahil-bhirud-scb712">
                                                <li>
                                                    <img src="img/linkedin.png" /></li>
                                            </a>
                                        </ul>
