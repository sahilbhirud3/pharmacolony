<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="pharmacolony.adminLogin" %>
            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="img/mediLogin.png" class="img-fluid" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <asp:Button ID="Button1" class="btn btn-primary btn-lg"
                                Style="padding-left: 2.5rem; padding-right: 2.5rem;" runat="server" OnClick="Button1_adminLogin" Text="Login" />
