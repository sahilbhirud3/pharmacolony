...
{
    public partial class showDist : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            {
                string sql = "SELECT[distributorName],[licNo],[firstName],[lastName],[email],[contact],[address],[state],[city] FROM[dbo].[distributor]";
