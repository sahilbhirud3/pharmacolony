...
{
    public partial class distForgotPassword : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new SqlCommand("select * from distributor where licNo COLLATE Latin1_general_CS_AS=@licno and email COLLATE Latin1_general_CS_AS=@emailId", con);
                ...
                if (dr.HasRows)
                {
                    ...
                    cmd = new SqlCommand("update distributor set uniqueCode=@uniqueCode where licNo=@licno and email=@emailid", con);
                    ...
                    strBody.Append("Dear "+licenseNumber.Text.Trim()+",<br>Your Password Reset Link is here,<br><a href=https://localhost:44364/distResetPassword?emailId=" + email.Text + "&licno=" + licenseNumber.Text + "&uCode=" + uniqueCode + ">Click here to change your password</a>");
