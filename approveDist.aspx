<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="approveDist.aspx.cs" Inherits="pharmacolony.WebForm3" %>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-12">
                    <h4 class="page-title">Pending Approvals of Distributors</h4>
                    <br />
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkEdit" CommandArgument='<%#Eval("licNo")%>' runat="server"
                                        CommandName="Edit" CssClass="btn-success" OnClick="lnkApprove_Click">Approve</asp:LinkButton>
