<%@ Page Title="" Language="C#" MasterPageFile="~/distMaster.Master" AutoEventWireup="true" CodeBehind="distAllOrderView.aspx.cs" Inherits="pharmacolony.distAllOrderView" %>
            ...
            <div class="row bg-title">
                <div class="col-lg-12">
                  ...
                  <div class="row"> 
                    ...
                    <asp:Button id="btnBack" class="btnBack" Text="Back" PostBackUrl="~/distAllOrder.aspx" runat="server"/>
                </div>
                </div>
