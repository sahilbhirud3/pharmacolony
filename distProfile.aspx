<%@ Page Title="" Language="C#" MasterPageFile="~/distMaster.Master" AutoEventWireup="true" CodeBehind="distProfile.aspx.cs" Inherits="pharmacolony.distProfile" %>
                        ...
                        <div class="user-bg">
                            <div class="overlay-box">
                                <div class="user-content">
                                    ...
                                    <h4 class="text-white"><asp:Label ID="distributorName" runat="server"></asp:Label></h4>
                                    <h5 class="text-white"><asp:Label ID="distributorUser" runat="server"></asp:Label></h5>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <asp:Button ID="chngPass" runat="server" class="btn btn-primary" Text="Change Password" PostBackUrl="distChangePass.aspx" />
