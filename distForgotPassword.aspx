<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="distForgotPassword.aspx.cs" Inherits="pharmacolony.distForgotPassword" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        ...
                        <div class="card-footer">
                            ...
                            <asp:Button ID="Button2" class="btn btn-danger" runat="server" Text="Back to Login" CausesValidation="false" PostBackUrl="distributorLogin.aspx" />
